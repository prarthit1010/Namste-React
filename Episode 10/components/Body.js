...
if(reslist.length === 0){
    ...
    <div >
         <div className="flex my-5 ">
            <div>
            <input type="text" className=" border border-black p-2 rounded mx-3" value={searchtext} onChange={(e) => { setsearchtext(e.target.value)}}></input> 
            <button className="bg-green-200 text-black px-4 py-2 rounded-md hover:bg-blue-600" onClick={() =>{
         ...
         <div>
             <button className=" mx-6 bg-green-200 text-black px-4 py-2 rounded-md hover:bg-blue-600" onClick={() => { const filterlist = reslist.filter(
